...
@Named("groupUserController")
@SessionScoped
public class GroupUserController implements Serializable {

    @EJB
    private com.mycompany.sessionbeanpackage.GroupUserFacade ejbFacade;
    ...
    public GroupUser getGroupUser(java.lang.Integer id) {
    ...
    public static class GroupUserControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getGroupUser(getKey(value));
        }
